...
### 3. Configure OS Voice

In OS Voice settings, add an Ollama API key with:
...
3. Verify the URL and port in OS Voice settings
...
3. Try refreshing the model picker in OS Voice
...
Then point OS Voice to `http://localhost:11434`.
