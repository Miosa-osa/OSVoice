...
const firebaseConfig: FirebaseOptions = {
  ...
  authDomain:
    import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || "osvoice-dev.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "osvoice-dev",
  storageBucket:
    import.meta.env.VITE_FIREBASE_STORAGE_BUCKET ||
    "osvoice-dev.firebasestorage.app",
  messagingSenderId:
