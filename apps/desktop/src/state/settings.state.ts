...
export type VibeCodingState = {
  variableRecognitionEnabled: boolean;
  fileTaggingEnabled: boolean;
};
...
export const INITIAL_SETTINGS_STATE: SettingsState = {
  ...
  vibeCoding: {
    variableRecognitionEnabled: false,
