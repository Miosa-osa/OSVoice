...
export const HANDS_FREE_HOTKEY = "hands-free";
export const PASTE_LAST_HOTKEY = "paste-last";
...
export const DEFAULT_HOTKEY_COMBOS: Record<string, PlatformHotkeyCombos> = {
  ...
  [HANDS_FREE_HOTKEY]: {
    macos: [["ControlLeft", "Space"]],
    windows: [["ControlLeft", "Space"]],
    linux: [["ControlLeft", "Space"]],
  },
  [PASTE_LAST_HOTKEY]: {
    macos: [["ControlLeft", "ShiftLeft", "KeyV"]],
    windows: [["ControlLeft", "ShiftLeft", "KeyV"]],
    linux: [["ControlLeft", "ShiftLeft", "KeyV"]],
  },
};
