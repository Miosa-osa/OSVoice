...
export const UpdateDialog = () => {
  ...
  const versionLabel = availableVersion
    ? intl.formatMessage(
        {
          defaultMessage: "OS Voice {version}",
        },
        { version: availableVersion },
      )
    : intl.formatMessage({
        defaultMessage: "A OS Voice update",
      });
    ...
    >
      <DialogTitle>
        ...
        <Typography variant="caption" color="text.secondary" component="p">
          <FormattedMessage defaultMessage="Release notes are AI-generated and may contain errors." />
        </Typography>
      </DialogTitle>
      <DialogContent>
        <Stack spacing={2} sx={{ mt: 1 }}>
          ...
          {status === "installing" && (
            <Alert severity="info" variant="outlined">
              <FormattedMessage defaultMessage="Installation in progress. OS Voice may restart automatically when finished." />
            </Alert>
          )}
