...
export const PillOverlayRoot = () => {
  ...
  const currentColors = isListening
    ? PILL_COLORS.recording
    : isProcessing
      ? PILL_COLORS.loading
      : PILL_COLORS.idle;
      ...
      >
        <Box
          ...
          sx={{
            ...
            border: `1px solid ${alpha(currentColors.border, 0.6)}`,
            backdropFilter: "blur(14px)",
            transition:
              "all 200ms ease-out, background-color 300ms ease-out, border-color 300ms ease-out",
            overflow: "hidden",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            ...
            boxShadow: isListening
              ? `0 0 12px ${alpha(currentColors.background, 0.5)}`
              : isProcessing
                ? `0 0 8px ${alpha(currentColors.background, 0.4)}`
                : "none",
          }}
        >
          ...
          >
            ...
            {isHovered && (
              <Typography
                sx={{
                  position: "absolute",
                  color: alpha(currentColors.text, 0.6),
                  fontSize: "11px",
                  fontWeight: 500,
            ...
            >
              <AudioWaveform
                ...
                strokeColor={currentColors.text}
            ...
            <Box
              sx={{
                ...
                pointerEvents: "none",
                opacity: isIdle ? 0 : 1,
                transition: "opacity 150ms ease-out, background 300ms ease-out",
