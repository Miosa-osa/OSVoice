...
export default function SettingsPage() {
  ...
  const openVibeCodingDialog = () => {
    produceAppState((draft) => {
      draft.settings.vibeCodingDialogOpen = true;
    });
  };
  ...
  const processing = (
    <Section
      ...
      description={
        <FormattedMessage defaultMessage="How OS Voice should manage your transcriptions." />
      }
    >
      <ListTile
  ...
  const vibeCoding = (
    <Section
      title={<FormattedMessage defaultMessage="Vibe coding" />}
      description={
        <FormattedMessage defaultMessage="Optimize OS Voice for coding in your favorite IDE." />
      }
    >
      <ListTile
        title={<FormattedMessage defaultMessage="IDE integration" />}
        subtitle={
          <FormattedMessage defaultMessage="Configure VS Code, Cursor, and Windsurf settings." />
        }
        leading={<CodeOutlined />}
        onClick={openVibeCodingDialog}
      />
    </Section>
  );
