...
Welcome to **OS Voice**. These Terms of Service ("Terms") govern your use of the OS Voice open source software application ("Software"). By downloading, installing, or using the Software, you agree to be bound by these Terms.

## 1. Open Source License

OS Voice is open source software. The Software's source code is available under the terms of its open source license (as specified in the repository). These Terms supplement, but do not replace, the applicable open source license.

## 2. No Account Required

OS Voice does not require account registration. You can download and use the Software freely without providing any personal information.
...
The "OS Voice" name and associated trademarks remain the property of their respective owners. Use of the Software does not grant you rights to use these trademarks except as permitted by the open source license.
...
If you contribute code, documentation, or other materials to the OS Voice project, you agree that your contributions will be licensed under the same open source license as the Software.
...
TO THE FULLEST EXTENT PERMITTED BY LAW, THE OSVOICE DEVELOPERS AND CONTRIBUTORS SHALL NOT BE LIABLE FOR ANY:
...
You agree to indemnify and hold harmless the OS Voice developers and contributors from any claims, damages, losses, liabilities, and expenses arising from:
...
These Terms, together with the applicable open source license, constitute the entire agreement between you and OS Voice regarding the Software.
...
- Contact us at [legal@osa.dev](mailto:legal@osa.dev)
