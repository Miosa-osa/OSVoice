    ...
    <section className={styles.heroSection} id="overview">
      <div className={styles.heroContent}>
        ...
        <p className={styles.heroSubtitle}>
          <FormattedMessage defaultMessage="Make voice your new keyboard. Type four times faster by using your voice. OSVoice is the open-source alternative to WisprFlow." />
        </p>
        <div className={styles.heroActions}>
          <DownloadButton trackingId="download-hero" />
          <a
            href="https://github.com/josiahsrc/osvoice"
            target="_blank"
        ...
        <div className={styles.heroMeta}>
          ...
          <a
            href="https://www.producthunt.com/products/osvoice?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-osvoice-2"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <img
              ...
              alt="OSVoice - The open source WisprFlow alternative | Product Hunt"
              width="250"
              height="54"
            />
          </a>
