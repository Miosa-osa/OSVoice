  ...
  return (
    <section className={styles.splitSection} id="privacy">
      <div className={styles.splitContent}>
        ...
        <p>
          <FormattedMessage defaultMessage="Process everything locally on your device, bring your own API key, or connect to our cloud. Don't believe us? See for yourself. OSVoice is fully open-source." />
        </p>
        <a
