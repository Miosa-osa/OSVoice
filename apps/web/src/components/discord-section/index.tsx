    ...
    <section className={styles.section} id="community">
      ...
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          <FormattedMessage defaultMessage="OS Voice is built in the open. Join our Discord to share feedback, request features, report bugs, or just hang out with other people. We're building this together." />
        </p>
        <a
