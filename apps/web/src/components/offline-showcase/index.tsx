  ...
  return (
    <section className={pageStyles.splitSection} id="offline">
      <div className={pageStyles.splitContent}>
        ...
        <p>
          <FormattedMessage defaultMessage="Other dictation tools send your audio straight to the cloud. OS Voice can run entirely on your device — your words never leave your machine. Airplane mode, off the grid, wherever. It just works." />
        </p>
      </div>
